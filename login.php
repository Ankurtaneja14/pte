...
<html lang="en">
  <head>
    <title>Galaxy Carrer | Login</title>
          ...
          <header data-thq="thq-navbar" class="home-navbar-interactive">
            ...
            <div data-thq="thq-navbar-nav" class="home-desktop-menu">
              <nav class="home-links">
                ...
                <span class="home-nav2"><a href="#">PTE Practice</a></span>
                <span class="home-nav2"><a href="contact.php">Contact Us</a></span>
                

              </nav>
              <div class="home-buttons">
                <button class="home-login button"><a href="#">Login</a></button>
            ...
            <div data-thq="thq-mobile-menu" class="home-mobile-menu">
              <div class="home-nav">
                ...
                <nav class="home-links1">
                  <span class="home-nav11"><a href="index.php"></a>Home</span>
                  <span class="home-nav21"><a href="about.php">About</a></span>
                  <span class="home-nav31"><a href="#">PTE Practice</a></span>
                  <span class="home-nav41"><a href="contact.php">Contact</a></span>
                </nav>
                <div class="home-buttons1">
                  <button class="home-login1 button"><a href="#">Login</a></button>
          ...
          <footer class="home-footer1">
            <div class="home-container7">
              ...
              <nav class="home-nav1">
                ...
                <span class="home-nav32"><a href="#">PTE Practice</a></span>
