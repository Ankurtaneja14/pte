...
<body>
  ...
  <main>
    <h1 class="mb-4 heading">Read Aloud Test</h1>
    <div class="container mt-5">
    <div class = "Instructions">
      <h1>Instructions:</h1>
      <ol>
      <li>Look at the text below. In 40 seconds, you must read this text aloud as naturally and clearly as possible. You have 40 seconds to read aloud.</li>
      </ol>
    </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="buttons">
            <button id="readAloudButton" class="btn btn-success">Read Aloud</button>
