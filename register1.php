...
<head>
    ...
    <title>PTE Practice - Registration</title>
...
<?php
    ...
    // Check if there is any error message from register_process.php
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 login-container">
                <h1 class="text-4xl font-bold text-center animated fadeInUp">Registration</h1>
                <?php if (isset($error_message)): ?>
                    <div class="alert alert-danger animated fadeInUp" role="alert">
                        <?php echo $error_message; ?>
                    </div>
                <?php endif; ?>
                <form action="register_process.php" method="POST" class="animated fadeInUp">
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-login animated-button">Register</button>
                </form>
            </div>
        </div>
    </div>
