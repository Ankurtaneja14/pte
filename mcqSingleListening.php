...
<main>
    <h1 class="quiz-title text-center heading">Multiple Choice Questions(Single)</h1>
    <div class="container mt-5">
      <div class = "Instructions">
        <h1>Instructions:</h1>
        <ol>
        <li>Listen to the recording and answer the single-choice question by selectingthe correct response . Only one response is correct.</li>
        </ol>
      </div>
...
xhr.open("GET", "mcqSingleListening.json", true);
