...
<main>
    <h1 class="quiz-title text-center heading">Highlight Correct Summary</h1>
    <div class="container mt-5">
      <div class = "Instructions">
        <h1>Instructions:</h1>
        <ol>
        <li>You will hear a recording. Click on the paragraph that best relates to the recording.</li>
        </ol>
      </div>
...
xhr.open("GET", "highlightSummary.json", true);
