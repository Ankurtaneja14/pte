...
<main>
    <h1 class="mb-4 heading">Describe Image Test</h1>
<div class="container mt-5">
<div class = "Instructions">
      <h1>Instructions:</h1>
      <ol>
      <li>Look at the graph below. In 25 seconds, please speak into the microphone and describe in detail what the graph is showing. You will have 40 seconds to give your response.</li>
      </ol>
    </div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="image-container">
                    ...
                    <div class="buttons">
                        ...
                        <button id="viewAnswerButton" class="btn btn-primary mt-4" hidden>View Answer</button>
                    </div>
...
function getRandomScore() {
    ...
    nextButton.addEventListener("click", function () {
        ...
        updateParagraph();
        currentImageIndex = (currentImageIndex + 1) % paragraphs.length;
        loadImage(currentImageIndex);
    ...
    function goToTestByIndex(index) {
        if (index >= 1 && index <= paragraphs.length) {
            ...
            updateParagraph();
            testIndex.innerText = currentParagraphIndex + 1;
            currentImageIndex = (currentParagraphIndex) % images.length;
            loadImage(currentImageIndex);
            submitButton.disabled = true;
            aiScore.style.display = "none";
            audioPlayer.style.display = "none";
