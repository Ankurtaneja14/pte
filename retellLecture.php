...
<body>
  ...
  <main>
    <h1 class="mb-4 heading">Retell Lecture Test</h1>
    <div class="container mt-5">
    <div class = "Instructions">
      <h1>Instructions:</h1>
      <ol>
      <li>You will hear a lecture. After listening to the lecture, in 10 seconds, please speak into the microphone and retell what you have just heard from the lecture in your own words. You will have 40 seconds to give your response.
</li>
      </ol>
    </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <p>Total Tests: 88</p>
          <p id="practiceParagraph">Loading paragraph...</p>
          <div class="buttons">
            <button id="readAloudButton" class="btn btn-success" hidden>Listen Lecture</button>
